...
filelist = {
        '/home/asya/Documents/data/odor_lesion/dat_preproc/RFles/RFles02.pckl',
        '/home/asya/Documents/data/odor_lesion/dat_preproc/RFles/RFles03.pckl',
        '/home/asya/Documents/data/odor_lesion/dat_preproc/RFles/RFles04_dy7.pckl',
        '/home/asya/Documents/data/odor_lesion/dat_preproc/RFles/RFles05_dy5.pckl',
        '/home/asya/Documents/data/odor_lesion/dat_preproc/RFles/RFles07_dy5_1.pckl',
        '/home/asya/Documents/data/odor_lesion/dat_preproc/RFles/RFles06_dy6_1.pckl',
        '/home/asya/Documents/data/odor_lesion/dat_preproc/RFles/RFles08_odor_dy5.pckl',
        '/home/asya/Documents/data/odor_lesion/dat_preproc/BIRT/BIRTles04_odor.pckl',
        '/home/asya/Documents/data/odor_lesion/dat_preproc/BIRT/BIRTles07_odor.pckl',
        '/home/asya/Documents/data/odor_lesion/dat_preproc/BIRT/BIRTles08_odor.pckl',
        '/home/asya/Documents/data/odor_lesion/dat_preproc/BIRT/BIRTles09_dy1_odor.pckl',
        '/home/asya/Documents/data/odor_lesion/dat_preproc/control/NW61_odor_dy1.pckl',
        '/home/asya/Documents/data/odor_lesion/dat_preproc/control/NW62_dy1_odor.pckl',
        '/home/asya/Documents/data/odor_lesion/dat_preproc/control/NW58_odor_2.pckl',
        '/home/asya/Documents/data/odor_lesion/dat_preproc/control/NW57_odor.pckl',
        '/home/asya/Documents/data/odor_lesion/dat_preproc/control/NW32_odor.pckl',
            }

type_by_file = {'RFles02':3,'RFles03':3,'RFles04':4,'RFles05':5,'RFles06':5,'RFles07':6}
type_by_file = {'RFles02.':-2,'RFles03.':3,'RFles04_':-4,'RFles05_':5,'RFles06_':6,'RFles07_':-7,'RFles08_':-8,\
                'IRTles04':14,'IRTles07':-17,'IRTles08':-18,'IRTles09':-19,\
                'l/NW60_o':160,'l/NW62_d':162,'l/NW61_o':161,'l/NW58_o':158,'l/NW57_o':157,'l/NW32_o':132,'l/NW21_o':121}
...
for fle in filelist:
    ...
    trialtype=np.hstack((M1*0+type_by_file[fle[56:64]],M2*0+type_by_file[fle[56:64]]))
...
for i in type_by_file:
    ...
    elif np.abs(type_by_file[i])>10 and type_by_file[i]<100:
...
fig_title = '/home/asya/Documents/data/odor_lesion/averages_all_dots.pdf'
...
fig_title = '/home/asya/Documents/data/odor_lesion/boxplots_v2.pdf'
plt.savefig(fig_title, format='pdf',dpi=fig.dpi)
#%%
fig = plt.figure()
ax = fig.add_subplot(111)
...
fig_title = '/home/asya/Documents/data/odor_lesion/boxplots_v1.pdf'
plt.savefig(fig_title, format='pdf',dpi=fig.dpi)
...
## EL lesion
trace_el_lesion = -L_all[:,(np.abs(trialtype_all)>10)*(trialtype_all<100)*(sidetype_all == 'lesion')]
...
## lesion
trace_lesion = -L_all[:,(np.abs(trialtype_all)<10)*(trialtype_all>0)*(sidetype_all == 'lesion')]
...
##nt lesion
trace_nt_lesion = -L_all[:,(np.abs(trialtype_all)<100)*(trialtype_all<0)*(sidetype_all == 'lesion')]
...
## All control
TC1 = L_all[:,(np.abs(trialtype_all)>10)*(trialtype_all<100)*(sidetype_all == 'control')]
TC2 = L_all[:,(np.abs(trialtype_all)<10)*(sidetype_all == 'control')]
...
fig_title = '/home/asya/Documents/data/odor_lesion/traces_all_average.pdf'
plt.savefig(fig_title, format='pdf',dpi=fig.dpi)
...
for stack in ALL_L.keys():
    a = histogram(ALL_L[stack],bins = np.arange(-4,4,0.1))
    a_tot = np.float(sum(a[0]))
    if type_by_file[stack] >0:
        if np.abs(type_by_file[stack])<10: #lesion
            color = 'm'
            L = L+a[0]/a_tot
    ...
    if type_by_file[stack] <0:
        ...
        if np.abs(type_by_file[stack])>10 and type_by_file[stack]<100: #el_lesion
            color = 'y'
            EL = EL + a[0]/a_tot
            TimeEL = TimeEL + len(ALL_L[stack])
            
        elif np.abs(type_by_file[stack])<10: #sindbis
            color = 'c'
            NT = NT + a[0]/a_tot
...
plt.plot(a[1][1:],log10(L/float(3)),'m')
plt.plot(a[1][1:],log10(EL/float(3)),'y')
plt.plot(a[1][1:],log10(NT/float(4)),'c')
fig_title = '/home/asya/Documents/data/odor_lesion/dist_pos_rat.pdf'
plt.savefig(fig_title, format='pdf',dpi=fig.dpi)
