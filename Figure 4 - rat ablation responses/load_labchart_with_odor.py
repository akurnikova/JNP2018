...
import numpy as np
sys.path.append('/home/asya/data/utilities/')
#from breathe_proc import util_proc_breathe
#from utils_filtering import util_lowpass, util_hipass
import pickle

datraw = si.loadmat("/home/asya/Documents/data/odor_lesion/raw_dat/RFles/RFles08_odor_dy4"); br_sign = 1; 
save_filename = '/home/asya/Documents/data/odor_lesion/dat_preproc/RFles/RFles08_odor_dy4.pckl'
